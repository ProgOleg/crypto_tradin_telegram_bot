...
{optional_msg_memo}
{optional_msg}
1️⃣ Для получения реквизитов на оплату отправьте это сообщение нашему оператору tg : @miracello 🤖

2️⃣ По факту совершения оплаты нажмите на кнопку - "Оплачено" 🤑
🌚Время ожидание оплаты - {expire} мин , в случае отсутствия перевода создайте новую заявку 🌖
