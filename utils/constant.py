...
class Constants:
    ...
    CONST_RELATIONS = {
        ...
        USDT_TRC20: {UAH, BTC, ETH, RUB, USD, XRP, LTC, TRX, USDC, BCH, XLM, DASH, SHIB, DOGE},
        USDT_ERC20: {UAH, BTC, ETH, RUB, USD, XRP, LTC, TRX, USDC, BCH, XLM, DASH, SHIB, DOGE},
    ...
    VARIATION_OF_COINS = {
        ...
        "usdt,usd", "doge,usdt", "trx,usdt", "usdt,uah", "usdt,rub", "dash,usdt", "trx,uah", "usdc,uah",
